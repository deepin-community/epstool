...
/* $Id: gdevdsp.h,v 1.2 2002/05/29 11:39:43 ghostgum Exp $ */
...
typedef enum DISPLAY_FORMAT_COLOR_e {
...
typedef enum DISPLAY_FORMAT_ALPHA_e {
 ...
 */
typedef enum DISPLAY_FORMAT_DEPTH_e {
    DISPLAY_DEPTH_1   = (1<<8),
    DISPLAY_DEPTH_2   = (1<<9),
 ...
 */
typedef enum DISPLAY_FORMAT_ENDIAN_e {
...
typedef enum DISPLAY_FORMAT_FIRSTROW_e {
 ...
 */
typedef enum DISPLAY_FORMAT_555_e {
